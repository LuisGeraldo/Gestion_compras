...
@Named("solicitudArticuloController")
@SessionScoped
public class SolicitudArticuloController implements Serializable {

    private SolicitudArticulo current;
    ...
    public SolicitudArticulo getSelected() {
        if (current == null) {
            current = new SolicitudArticulo();
            selectedItemIndex = -1;
        }
        return current;
    }

    private SolicitudArticuloFacade getFacade() {
        return ejbFacade;
    }
    ...
    public String prepareView() {
        current = (SolicitudArticulo) getItems().getRowData();
    ...
    public String create() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("SolicitudArticuloCreated"));
    ...
    public String update() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("SolicitudArticuloUpdated"));
            return "View";
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
            return null;
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("SolicitudArticuloDeleted"));
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
        }
    }
    ...
    public static class SolicitudArticuloControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            SolicitudArticuloController controller = (SolicitudArticuloController) facesContext.getApplication().getELResolver().
                    getValue(facesContext.getELContext(), null, "solicitudArticuloController");
            return controller.getSolicitudArticulo(getKey(value));
        }
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof SolicitudArticulo) {
                SolicitudArticulo o = (SolicitudArticulo) object;
                return getStringKey(o.getId());
            } else {
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: " + SolicitudArticulo.class.getName());
            }
        }
